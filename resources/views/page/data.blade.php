...
-->
        ...
        <!-- Snippet -->
        <section
            class="flex min-h-screen flex-col justify-center bg-gray-100 text-gray-600 antialiased"
        >
            <div class="mx-auto h-full max-w-3xl p-4 sm:px-6">
                <!-- Chart widget -->
                <div
                    class="col-span-full flex flex-col rounded-sm border border-gray-200 bg-white shadow-lg xl:col-span-8"
                >
                    <header
                        class="flex items-center border-b border-gray-100 px-5 py-4"
                    >
                            ...
                            <div class="flex items-center py-2">
                                <div class="mr-5">
                                    <div class="flex items-center">
                                        <div
                                            class="mr-2 text-3xl font-bold text-gray-800"
                                        >
                                            24.7K
                                        </div>
                                        <div
                                ...
                                <div
                                    class="mr-5 hidden h-8 w-px bg-gray-200 md:block"
                                    aria-hidden="true"
                                ></div>
                            </div>
                            <!-- Total Pageviews -->
        ...
        <div
            x-show="open"
            class="z-60 fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto"
            x-data="{ open: true }"
        >
            <div
                class="flex justify-between bg-gray-800 p-3 text-sm text-gray-50 shadow-lg md:rounded"
            >
                <div>
                    👉
                    <a
                ...
                <button
                    class="ml-5 text-gray-500 hover:text-gray-400"
                    @click="open = false"
                >
                    <span class="sr-only">Close</span>
                    <svg
                        class="h-4 w-4 flex-shrink-0 fill-current"
                        viewBox="0 0 16 16"
                    >
                        <path
